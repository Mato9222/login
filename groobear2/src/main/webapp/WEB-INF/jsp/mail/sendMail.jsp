		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="d-flex align-items-center gap-2 gap-lg-3">
					...
					<button class="btn btn-sm fw-bold btn-primary openEmp adrss" >주소록</button>
							...
							<form id="kt_inbox_compose_form" method="post" action="/mail/send" enctype="multipart/form-data">
								...
								<div class="d-block">
									...
									<div class="d-flex align-items-center border-bottom px-8 min-h-50px">
										...
										<!--end::Label-->
										<!--begin::Input-->
										<input type="text" id="input-container" name="realMail" class="form-control form-control-transparent border-0" value="" data-kt-inbox-form="tagify" />
									...
									<div class="d-flex align-items-center border-bottom px-8 min-h-50px">
										...
										<!--end::Label-->
										<!--begin::Input-->
										<input type="text" id="pCc" class="form-control form-control-transparent border-0" value="" data-kt-inbox-form="tagify" />
									...
									<div class="border-bottom ">
										<input class="form-control form-control-transparent border-0 px-8 min-h-45px" name="subject" placeholder="제목" />
									</div>
									<!--end::제목-->
									<!--begin::내용-->
									<div id="kt_inbox_form_editor" class="d-flex align-items-center border-bottom px-8 min-h-50px">
										<textarea class="d-flex align-items-center border-bottom px-8 min-h-50px form-control form-control-transparent border-0 px-8 min-h-45px" name="content" rows="15" data-kt-element="input" placeholder="내용"></textarea>
									</div>
									<!--end::내용-->
									<!--begin::첨부파일 버릴까 고민중-->
...
document.addEventListener("DOMContentLoaded", () => {
	$(".adrss").on("click", function(e) {
		...
		popup.onload = function() {
			popup.postMessage({ emplHidden: emplHidden, emplValue: emplValue }, window.location.origin);
			popup.postMessage({ ccHidden: ccHidden, pCc: pCc }, window.location.origin);
		}
	})
	...
	$(".send").on("click", function(e) {
		...
		frmData.append("realMail", realMail);
	...
	$(".temp").on("click", function(e) {
		...
		let title = $('input[name=subject]').val(); // 제목
		let content = $('textarea[name=content]').val(); // 내용
		let att = $('input[name=mailFile]'); // 첨부파일
